    ...
    @section('content')
        ...
        <div class="row">
            ...
            <section class="col-lg-5 connectedSortable">
                @include('includes.if-authorized', ['conditions'=> array('or'=>array(), 'and'=>array(), 'rol'=>array('Super Usuario','Director')),'include'=>'tasks.manage', 'parameters'=>['title'=>'Estado de tareas globales']])
                @include('includes.if-authorized', ['conditions'=> array('or'=>array(), 'and'=>array(), 'rol'=>array('Super Usuario','Director','Recepcion y Conserjeria','Pisos','Mantenimiento, servicios técnicos y seguridad:')),'include'=>'mail.write', 'parameters'=>['title'=>'Envío de Emails']])
            </section><!-- right col -->
        </div><!-- /.row (main row) -->
    @endsection